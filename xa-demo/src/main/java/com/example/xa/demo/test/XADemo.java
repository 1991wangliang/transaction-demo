package com.example.xa.demo.test;
...
public class XADemo {
    ...
    private String sql_1 = "INSERT INTO T_DEMO(name) VALUES('xa-demo1')";
    private String sql_2 = "INSERT INTO T_DEMO(name) VALUES('xa-demo2')";

    public void test(){
        Connection connection_1 = null;
        Connection connection_2 = null;
        MysqlXADataSource xaDataSource_1 = null;
        MysqlXADataSource xaDataSource_2 = null;
        Xid xid_1 = null;
        Xid xid_2 = null;
        ...
        MysqlXADataSource[] xaDataSources = initXADataSource();
    ...
    MysqlXADataSource[] initXADataSource() {
        System.out.print("Create a XADataSource_1 data source: ");
        MysqlXADataSource xaDataSource_1 = new MysqlXADataSource();
        xaDataSource_1.setUrl(environment.getProperty("db1.url"));
        xaDataSource_1.setUser(environment.getProperty("db1.username"));
        xaDataSource_1.setPassword(environment.getProperty("db1.password"));
        System.out.println("Okay.");

        System.out.print("Create a XADataSource_2 data source: ");
        MysqlXADataSource xaDataSource_2 = new MysqlXADataSource();
        xaDataSource_2.setUrl(environment.getProperty("db2.url"));
        xaDataSource_2.setUser(environment.getProperty("db2.username"));
        xaDataSource_2.setPassword(environment.getProperty("db2.password"));
        System.out.println("Okay.");
        return new MysqlXADataSource[]{xaDataSource_1, xaDataSource_2};
    }

    XAConnection[] initXAConnection(MysqlXADataSource xaDataSource_1, MysqlXADataSource xaDataSource_2) {
    ...
    Xid[] createXID() {
        ...
        gid_1[0] = (Byte.decode(environment.getProperty("xid.global"))).byteValue();
        bid_1[0] = (Byte.decode(environment.getProperty("xid.branch.db_1"))).byteValue();
        ...
        gid_2[0] = (Byte.decode(environment.getProperty("xid.global"))).byteValue();
        bid_2[0] = (Byte.decode(environment.getProperty("xid.branch.db_2"))).byteValue();
